...
async function fetchAndUpdateHistory() {
  ...
  try {
    ...
    // Pastikan sensorData memiliki data yang valid sebelum menambahkan ke tabel
    if (sensorData.every(data => data)) {
      ...
      console.log('Data is empty or invalid, not adding row.');
    }
